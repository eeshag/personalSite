...
So take this as your reminder: worrying about what you cannot control will not change the outcome, but giving your best effort to what you can control will.`
  },
  {
    ...
    url: '/blogs/chemical-reactions-lab',
    excerpt: 'A recap of our chemistry workshop, from elephant toothpaste to very messy oobleck.',
    summary:
      'Eesha recaps the Chemical Reactions Lab workshop, including chemistry concepts, live demos, messy oobleck, and lessons from attendance and timing surprises.',
    date: '2026-04-20',
    icon: '\u{1F9EA}',
    color: '#14B8A6',
